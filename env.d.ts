/* eslint-disable */
// Generated by Wrangler by running `wrangler types env.d.ts` (hash: bb9ca3363a31c393b00fbc8ca4be5999)
...
interface __BaseEnv_Env {
	...
	CODEX_REVIEW_WORKFLOW: Workflow<Parameters<import("./src/server").CodexReviewWorkflow['run']>[0]['payload']>;
}
